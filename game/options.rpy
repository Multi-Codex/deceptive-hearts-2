...
define config.name = "Deceptive Hearts 2"
...
define build.name = "DeceptiveHearts2"
...
# main menu.
define config.main_menu_music = audio.eiirp2
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DH2"

# This controls the window logo of your mod.
define config.window_icon = "mod_assets/windowicon.png"

...
transform fall(x=640, z=0.80):
    xcenter x yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True matrixtransform OffsetMatrix(0.0, 0.0, 0.0)*RotateMatrix(0.0, 0.0, 0.0)
    easeout 0.5 yoffset 2000 matrixtransform OffsetMatrix(0.0, 0.0, 0.0)*RotateMatrix(0.0, 0.0, -70.0)

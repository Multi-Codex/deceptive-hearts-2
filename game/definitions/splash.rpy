...
init python:
    ...
    # the game launches.
    splash_message_default = "In loving memory of Soldi."
...
transform menu_logo_rotate:
    rotate_pad True
    easein_quad 1 rotate -10.0
    pause 0.01
    easeout_quad 1.5 rotate 0
    pause 0.01
    easein_quad 2 rotate 10
    pause 0.01
    easeout_quad 1.5 rotate 0
    pause 0.01
    repeat
...
image yuri_menu:
    ...
    block:
        choice:
            "ghyuri turned curi lup rhook"
            renpy.random.randint(20, 30)*0.1
        choice:
            "cleb 4v"
            renpy.random.randint(20, 50)*0.1
        choice:
            "david 4j"
            renpy.random.randint(20, 50)*0.1
        choice:
            "chadmc turned winter anno"
            renpy.random.randint(20, 50)*0.1
        choice:
            "saul turned circus happ lpoint rpoint"
            renpy.random.randint(20, 50)*0.1
        choice:
            "harumi 1j"
            renpy.random.randint(20, 50)*0.1
        choice:
            ...
            renpy.random.randint(20, 50)*0.1
        choice:
            "natsuki turned proto doub lhip"
            renpy.random.randint(20, 50)*0.1
        choice:
            "amaya 3d"
            renpy.random.randint(20, 50)*0.1
...
image junichi_menu:
    ...
    block:
        choice:
            "junichi base casual flus mf"
            renpy.random.randint(20, 30)*0.1
        choice:
            "mh_mc turned casual crossed mg"
            renpy.random.randint(20, 50)*0.1
        choice:
            "phoenix 2g"
            renpy.random.randint(20, 50)*0.1
        choice:
            ...
            renpy.random.randint(20, 50)*0.1
        choice:
            "wallace forward casual lsur lhip"
            renpy.random.randint(20, 50)*0.1
        choice:
            "chitoge turned lup rhold ma ec"
            renpy.random.randint(20, 50)*0.1
        choice:
            "nastya turned coat laug glasses"
            renpy.random.randint(20, 50)*0.1
    repeat
#1
image menu_art_spirit:
    subpixel True
    "spirit_menu"
    xcenter 150
    ycenter 460
...
image spirit_menu:
    ...
    block:
        choice:
            ...
            renpy.random.randint(20, 30)*0.1
        choice:
            "headlocker turned casual happ"
            renpy.random.randint(20, 50)*0.1
        choice:
            "amana 6i"
            renpy.random.randint(20, 50)*0.1
        choice:
            "kotonoha toward winter happ om lup"
            renpy.random.randint(20, 50)*0.1
        choice:
            "dadsuki turned nerv cross"
            renpy.random.randint(20, 50)*0.1
        choice:
            "amy turned casual lsur rback"
            renpy.random.randint(20, 50)*0.1
        choice:
            "soverytired 1b"
            renpy.random.randint(20, 50)*0.1
        choice:
            "sayori turned winter flus lup"
            renpy.random.randint(20, 50)*0.1
        choice:
            "lueck 1e"
            renpy.random.randint(20, 50)*0.1
...
image kryo_menu:
    ...
    block:
        choice:
            ...
            renpy.random.randint(20, 30)*0.1
        choice:
            "reiko base casual rthink n2 md e1a b1a"
            renpy.random.randint(20, 50)*0.1
        choice:
            "fit 2o"
            renpy.random.randint(20, 50)*0.1
        choice:
            "skinny_mc turned mean ldown rhip"
            renpy.random.randint(20, 50)*0.1
        choice:
            "dpmc 3a"
            renpy.random.randint(20, 50)*0.1
        choice:
            ...
            renpy.random.randint(20, 50)*0.1
        choice:
            "miyuki turned nb md eb"
            renpy.random.randint(20, 50)*0.1
        choice:
            "sayonika turned jacket ldown rdown nb ef ma"
            renpy.random.randint(20, 50)*0.1
        choice:
            "bryson 1a"
            renpy.random.randint(20, 50)*0.1
...
image intro:
    ...
    "white"
    0.5
    "mod_assets/codex.png" with Dissolve(0.5, alpha=True)
    2.5
...
image tos = "mod_assets/bw.png"
image tos2 = "mod_assets/splash.png"
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "This mod is also a direct sequel to Deceptive Hearts, made by iiTzWolfyy and Codex (me) and is the offical sequel."
        "My condolences, Ninja."
        "Also, again, don't take anything in this mod seriously. It's a comedy mod for a reason."
    ...
    $ config.main_menu_music = audio.eiirp2
    $ renpy.music.play(config.main_menu_music)
...
label before_main_menu:
    $ config.main_menu_music = audio.eiirp2
    $ renpy.notify("Wretched Team- Everything In It's Right Place")
    return

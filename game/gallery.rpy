...
init python:
    ...
    mas = GalleryImage("mod_assets/gallery/1.png", name="Smelly",  already_unlocked=True)
    codex = GalleryImage("mod_assets/gallery/2.png", name="Sayori on Bed",artist="Stormblazed76", already_unlocked=True)
    m1a = GalleryImage("mod_assets/gallery/3.png", name="Shawarma", already_unlocked=True)
    m1 = GalleryImage("mod_assets/gallery/4.png", name="Pure Milk", already_unlocked=True)
    m2 = GalleryImage("mod_assets/gallery/5.png", name="Kill this Guy", already_unlocked=True)
    m3 = GalleryImage("mod_assets/gallery/6.png", name="Shane vs Bane", already_unlocked=True)
    m4 = GalleryImage("mod_assets/gallery/7.png", name="The Drawing", already_unlocked=True)
    m5 = GalleryImage("mod_assets/gallery/8.png", name="Strain the Milk", already_unlocked=True)
    m6 = GalleryImage("mod_assets/gallery/9.png", name="Make a Car", already_unlocked=True)
    m7 = GalleryImage("mod_assets/gallery/10.png", name="Copypasta", already_unlocked=True)
    m8 = GalleryImage("mod_assets/gallery/ewan.png", name="Ewan", already_unlocked=True)
    m9 = GalleryImage("mod_assets/gallery/11.png", name="America Fuck Yeah", already_unlocked=True)
    m10 = GalleryImage("mod_assets/gallery/12.png", name="Devious Kryo", already_unlocked=True)
    m11 = GalleryImage("mod_assets/gallery/13.jpg", name="All Dokis are Mid", already_unlocked=True)
    m12 = GalleryImage("mod_assets/gallery/14.png", name="Late Night Show Starring Shane", already_unlocked=True)
    m13 = GalleryImage("mod_assets/gallery/15.png", name="Account Verification", already_unlocked=True)
    m14 = GalleryImage("mod_assets/gallery/16.png", name="You're Probationary", already_unlocked=True)
    m16 = GalleryImage("mod_assets/gallery/18.png", name="Live Codex Reaction", already_unlocked=True)
    m17 = GalleryImage("mod_assets/gallery/19.png", name="Codex Biden Allegations", already_unlocked=True)
    m18 = GalleryImage("mod_assets/gallery/20.png", name="The Extra G", already_unlocked=True)
    m19 = GalleryImage("mod_assets/gallery/21.png", name="MGT in Deceptive Hearts", already_unlocked=True)
    m20 = GalleryImage("mod_assets/gallery/22.jpg", name="High Impact", already_unlocked=True)
    m21 = GalleryImage("mod_assets/gallery/23.png", name="Old Logo", artist="Leomonade33", already_unlocked=True)
    m22 = GalleryImage("mod_assets/gallery/24.png", name="Sayori CG Sketch", artist="Stormblazed76", already_unlocked=True)
    m23 = GalleryImage("mod_assets/gallery/25.png", name="The Hottest Thing", already_unlocked=True)
    m24 = GalleryImage("mod_assets/gallery/26.png", name="Old Logo 2", already_unlocked=True)

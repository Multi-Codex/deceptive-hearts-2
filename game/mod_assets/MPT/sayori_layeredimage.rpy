layeredimage sayori turned: #turned definitions.
    ...
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="sayori turned")]
    
    always if_not "wedding" "mod_assets/MPT/sayori/sayori_turned_facebase.png"

    group head:
        attribute head default if_any "uniform":
            "mod_assets/MPT/sayori/sayori_turned_facebase.png"
        attribute wedding if_any "bridal":
            "mod_assets/MPT/sayori/wedhead.png"
    ...
    group outfit: #These attributes are here only to determine which set of "body" sprites to use later.  "null" is what lets us just use these attributes as logic and nothing else.
        ...
        attribute bridal null
        attribute proto null
    ...
    group left if_any(["bridal"]):
        attribute ldown default:
            "mod_assets/MPT/sayori/sayori_turned_bridal_left_down.png"
        attribute lup:
            "mod_assets/MPT/sayori/sayori_turned_bridal_left_up.png"
    
    group left if_any(["proto"]):
        attribute ldown default:
            "mod_assets/MPT/sayori/1l.png"
        attribute lup:
            "mod_assets/MPT/sayori/2l.png"

    group left if_any(["winter"]):
        attribute ldown default:
            "mod_assets/MPT/sayori/winter/1l.png"
        attribute lup:
            "mod_assets/MPT/sayori/winter/2l.png"
    ...
    group right if_any(["bridal"]):
        attribute rdown default:
            "mod_assets/MPT/sayori/sayori_turned_bridal_right_down.png"
        attribute rup:
            "mod_assets/MPT/sayori/sayori_turned_bridal_right_up.png"

    group right if_any(["proto"]):
        attribute rdown default:
            "mod_assets/MPT/sayori/1r.png"
        attribute rup:
            "mod_assets/MPT/sayori/2r.png"

    group right if_any(["winter"]):
        attribute rdown default:
            "mod_assets/MPT/sayori/winter/1r.png"
        attribute rup:
            "mod_assets/MPT/sayori/winter/2r.png"
...
layeredimage sayori tap: #tapping definitions.
    ...
    #This makes the sprite one single texture, instead of multiple textures on top of each other.
    #This fixes certain problems like alpha fadein/fadeout looking strange, at the cost of some performance.
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="sayori tap")]
    ...
    group outfit:
        ...
        attribute winter:
            "mod_assets/MPT/sayori/winter/3a.png"

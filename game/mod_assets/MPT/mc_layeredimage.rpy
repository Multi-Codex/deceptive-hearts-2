...
layeredimage headlocker turned: #turned definitions.
    ...
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="headlocker turned")]
    ...
    group center if_any(["winter"]) if_all(["turned"]):
        attribute turned default:
            "mod_assets/MPT/mc/winter/1.png"
...
layeredimage headlocker cross: #crossed definitions.

    #This makes the sprite one single texture, instead of multiple textures on top of each other.
    #This fixes certain problems like alpha fadein/fadeout looking strange, at the cost of some performance.
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="headlocker cross")]
    ...
    group center if_any(["winter"]) if_all(["cross"]):
        attribute cross default:
            "mod_assets/MPT/mc/winter/2.png"

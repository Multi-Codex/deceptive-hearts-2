...
layeredimage natsuki turned:
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="natsuki turned")]
    ...
    group left: #Left arm.
        ...
        attribute ldown default if_any(["proto"]):
            "mod_assets/MPT/natsuki/1l.png"
        attribute ldown default if_any(["winter"]):
            "mod_assets/MPT/natsuki/winter/1l.png"
        ...
        attribute lhip if_any(["proto"]):
            "mod_assets/MPT/natsuki/2l.png"
        attribute lhip if_any(["winter"]):
            "mod_assets/MPT/natsuki/2l.png"
        ...
        attribute lpoint if_any(["winter"]):
            "mod_assets/MPT/natsuki/winter/5l.png"
    ...
    group right: #right half of her body.
        ...
        attribute rdown default if_any(["proto"]):
            "mod_assets/MPT/natsuki/1r.png"
        attribute rdown default if_any(["winter"]):
            "mod_assets/MPT/natsuki/winter/1r.png"
        ...
        attribute rhip if_any(["proto"]):
            "mod_assets/MPT/natsuki/2r.png"
        attribute rhip if_any(["winter"]):
            "mod_assets/MPT/natsuki/winter/2r.png"
...
layeredimage natsuki cross:
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="natsuki cross")]
    ...
    always:
        "mod_assets/MPT/natsuki/3.png" if_all(["proto"])
    always:
        "mod_assets/MPT/natsuki/winter/3.png" if_all(["winter"])

...
define chadmc = DynamicCharacter('player', image='chadmc', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")

layeredimage chadmc turned:

    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="chadmc turned")]
    ...
    always "mod_assets/MPT/chadmc/chadmc_uniform_facebase.png"  if_all(["uniform"])
    always "mod_assets/MPT/chadmc/chadmc_casual_facebase.png"  if_all(["casual"])
    always "mod_assets/MPT/chadmc/chadmc_casual_facebase.png"  if_all(["winter"])
    ...
    group left:
        ...
        attribute lshrug if_any(["winter"]):
            "mod_assets/MPT/chadmc/3.png"
        attribute lthink if_any(["uniform"]):
            "mod_assets/MPT/chadmc/chadmc_uniform_left_think.png"
        attribute lthink if_any(["winter"]):
            "mod_assets/MPT/chadmc/5a.png"
    ...
    group right:
        ...
        attribute rdown default if_any(["casual"]):
            "mod_assets/MPT/chadmc/chadmc_casual_right_down.png"
...
layeredimage chadmc cross:
    ...
    at [renpy.partial(Flatten, drawable_resolution=False), AutofocusDisplayable(name="chadmc cross")]
    ...
    always "mod_assets/MPT/chadmc/chadmc_uniform_cross.png"  if_all(["uniform"])

    always "mod_assets/MPT/chadmc/chadmc_casual_facebase.png"  if_all(["winter"])
    always "mod_assets/MPT/chadmc/4.png"  if_all(["winter"])

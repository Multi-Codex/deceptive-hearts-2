...
define -2 text_outline_color = "#960f9b"
...
style game_menu_outer_frame:
    ...
    background "mod_assets/main_menu.png"
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                hbox:
                    null width 300
                    add Transform("mod_assets/logo.png", size=(200,200))
...
style slot_button:
    ...
    idle_background Frame("mod_assets/idle.png", gui.choice_button_borders)
    hover_background Frame("mod_assets/select.png", gui.choice_button_borders)
...
style pref_label_text:
    ...
    size 24
    color "#fff"
    outlines [(3, "#960f9b", 0, 0), (1, "#960f9b", 1, 1)]
    yalign 1.0
...
style notify_frame:
    ...
    background Frame("mod_assets/notify.png", gui.notify_frame_borders, tile=gui.frame_tile)
